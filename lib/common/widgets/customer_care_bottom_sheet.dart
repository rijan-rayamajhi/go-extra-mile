...
class CustomerCareBottomSheet extends StatelessWidget {
  ...
  static void show(
    ...
    showModalBottomSheet(
      ...
      builder: (context) => CustomerCareBottomSheet(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  if (whatsappNumber != null) _buildSupportOption(
                    context,
                  ...
                  if (emailAddress != null) _buildSupportOption(
                    context,
                  ...
                  if (emailAddress != null && phoneNumber != null)
                    const SizedBox(height: 12),
                  if (phoneNumber != null) _buildSupportOption(
                    context,
