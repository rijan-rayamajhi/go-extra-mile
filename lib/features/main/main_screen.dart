...
import 'package:go_extra_mile_new/features/main/home_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  late final List<Widget> _pages = [
    const HomeScreen(),
    EarnGemCoinScreen(),
    const StartRideScreen(), // This won't be used directly due to navigation logic
    const RedeemScreen(),
    const Center(
      child: Text(
        'Rewards',
  ...
  void _onItemTapped(int index) async {
    ...
    if (index == 2) {
      ...
      try {
        ...
        final bool isActiveRide = state.isTracking;
        final Widget target = isActiveRide
