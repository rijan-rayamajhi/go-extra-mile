...
class MyVehicleGridViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...vehicles.map((vehicle) => PremiumVehicleCard(
          vehicle: vehicle,
        )),
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: CachedNetworkImageProvider(vehicle.vehicleBrandImage),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                    ...
                    gradient: LinearGradient(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Add Vehicle Image', style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                            fontSize: 12,
