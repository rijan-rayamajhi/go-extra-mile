...
class MyVehicleDetailsVehicleImageWidget extends StatefulWidget {
  final String? frontImageUrl;
  final String? backImageUrl;
  final String vehicleId, userId;
  final bool hideDeleteButton;

  const MyVehicleDetailsVehicleImageWidget({
    super.key,
    this.frontImageUrl,
    this.backImageUrl,
  ...
  @override
  State<MyVehicleDetailsVehicleImageWidget> createState() =>
      _MyVehicleDetailsVehicleImageWidgetState();
}

class _MyVehicleDetailsVehicleImageWidgetState
    extends State<MyVehicleDetailsVehicleImageWidget> {
  ...
  Widget _buildImageContainer(String imageType, String? imageUrl) {
    ...
    final addLabel = isFront ? 'Add Vehicle Front Image' : 'Add Vehicle Back Image';
          ...
          children: [
            ...
            if (imageUrl != null) ...[
              Positioned(
                top: 8,
                left: 8,
                child: _overlayLabel("Vehicle $label"),
              ),
      ...
      listener: (context, state) {
        if (state is VehicleLoaded) {
          ...
          setState(() {
            ...
            _localFrontImageUrl = vehicle?.vehicleFrontImage;
            _localBackImageUrl = vehicle?.vehicleBackImage;
          });
